...
const bio = {
  PT: (link: string, locale: string) => (
    <>
      ...
      <p className="paragraph mb-3">
        Anteriormente, colaborei com <a href="https://www.goiasec.com.br/" target="_blank" className={link} rel="noopener noreferrer">Goiás F.C.</a> e outros. Faço curadoria de <a className={link} href={`/${locale}/monthly-playlists`}>playlists</a> todo mês e corro todo dia.
      </p>
  ...
  EN: (link: string, locale: string) => (
    <>
      ...
      <p className="paragraph mb-3">
        Previously, I collaborated with <a href="https://www.goiasec.com.br/" target="_blank" className={link} rel="noopener noreferrer">Goiás F.C.</a> and others. I curate <a className={link} href={`/${locale}/monthly-playlists`}>playlists</a> every month and run every day.
      </p>
      <p className="paragraph">
  ...
  ES: (link: string, locale: string) => (
    <>
      ...
      <p className="paragraph mb-3">
        Anteriormente, colaboré con <a href="https://www.goiasec.com.br/" target="_blank" className={link} rel="noopener noreferrer">Goiás F.C.</a> y otros. Hago curaduría de <a className={link} href={`/${locale}/monthly-playlists`}>playlists</a> cada mes y corro todos los días.
      </p>
      <p className="paragraph">
    ...
    <div className="relative flex min-h-dvh w-full flex-col overflow-x-hidden">
      <main className="mx-auto flex w-full max-w-(--breakpoint-sm) flex-1 flex-col px-4 pt-20 pb-4 dark:text-[#b4b4b4] text-gray-600">
        ...
        <div className="mt-16 sm:mt-32 mb-4">
          ...
          <div className="flex flex-col gap-1">
            <Link
              href={`/${locale}/work/invisible-details`}
            ...
            <Link
              href={`/${locale}/work/whatsapp-cloud-api`}
              className="group -mx-2 flex items-center gap-3 rounded-xl px-2 py-2 transition-colors duration-200 ease-out hover:bg-secondary"
            >
      ...
      <Footer
        ...
        onLanguageChange={(lang) => {
          router.push(`/${languageToLocale[lang]}`, { scroll: false })
        }}
      />
    </div>
  )

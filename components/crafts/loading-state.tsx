...
export function LoadingState({
  ...
  return (
    ...
    <div role="status" className="flex w-fit items-center gap-2.5">
      ...
      {/* Reduced motion gets flat ink, not a frozen gradient: a shimmer held
          still is just a word that fades out at both ends for no reason. */}
      {reduced ? (
      ...
      <span className="font-mono text-[12px] text-gray-1000 tabular-nums">{elapsed}</span>
    </div>
  )
}

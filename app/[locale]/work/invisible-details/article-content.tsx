  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full flex-col overflow-x-hidden">
      ...
      <main className="mx-auto w-full max-w-(--breakpoint-sm) flex-1 px-4 py-12 leading-relaxed sm:py-20">
        ...
        <article>
          <h1 className="mb-2 w-fit scroll-mt-20 text-balance font-[550] article-heading" id="invisible-details">
            {t.title}
          </h1>
          ...
          <h2 className="mt-16 mb-2 w-full text-balance font-[550] article-heading scroll-mt-20" id="more">{t.more}</h2>
          ...
          <ArticleNav slug="invisible-details" language={language} locale={locale} />
        </article>
      </main>

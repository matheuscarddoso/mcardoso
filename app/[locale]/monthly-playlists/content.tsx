...
const spotifyFeb2026 =
  "https://open.spotify.com/playlist/7taNw0eVv4qK5QPb2G4mtn?si=qNSyjXcUSWezUSoUsjM5Uw";
            ...
            return (
              <li key={`${pl.month}-${pl.year}`}>
                ...
                >
                  ...
                  <span className="text-sm font-[450] text-zinc-700 dark:text-zinc-300">
                    {label}
                  </span>
                </a>
              </li>

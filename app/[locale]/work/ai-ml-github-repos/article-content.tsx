...
function SectionHeading({
  ...
  return (
    ...
    >
      {n !== undefined && (
        <span className="text-gray-1000 tabular-nums">{n}. </span>
      )}
      {children}
    </h2>
  );
...
const translations = {
  PT: {
    ...
    intro: (
      <>
        A maioria de quem está aprendendo IA não sabe que esses repositórios
        existem, e eles economizariam meses. São os cinco que eu manteria nos
        favoritos se estivesse começando machine learning hoje: da primeira
        linha de Python até construir projetos de verdade. Todos completamente
        gratuitos.
      </>
    ),
  ...
  EN: {
    ...
    intro: (
      <>
        Most people learning AI have no idea these exist, and they&apos;d save
        you months. These are the five GitHub repos I&apos;d keep bookmarked if
        I were learning machine learning today, going from your first line of
        Python all the way to building real projects. Every single one is
        completely free.
      </>
    ),
  ...
  ES: {
    ...
    intro: (
      <>
        La mayoría de quienes están aprendiendo IA no sabe que estos
        repositorios existen, y ahorrarían meses. Son los cinco que mantendría
        en favoritos si estuviera aprendiendo machine learning hoy: desde tu
        primera línea de Python hasta construir proyectos reales. Todos
    ...
    pythonP2:
      "Haz un poco cada día y tendrás la base sobre la que se construye todo lo demás.",
    ...
    microsoftP2:
      "Trátalo como tu curso principal una vez que las bases de Python estén firmes.",
    ...
    stanfordP2:
      "Perfecto para repasar un concepto rápido sin excavar un libro entero.",
    ...
    awesomeP2:
      "Un poco abrumador al principio, pero increíblemente útil cuando ya sabes qué buscas.",
    ...
    <div className="relative flex min-h-[100dvh] w-full flex-col overflow-x-hidden">
      ...
      <main className="mx-auto w-full max-w-(--breakpoint-sm) flex-1 px-4 py-12 leading-relaxed sm:py-20">
        ...
        <article>
          ...
          <SectionHeading id="30-days-of-python" n={1}>
            {t.python}
          </SectionHeading>
          ...
          <SectionHeading id="ml-for-beginners" n={2}>
            {t.microsoft}
          </SectionHeading>
          ...
          <SectionHeading id="cs229-cheat-sheets" n={3}>
            {t.stanford}
          </SectionHeading>
          ...
          <SectionHeading id="500-projects" n={4}>
            {t.projects}
          </SectionHeading>
          ...
          <SectionHeading id="awesome-machine-learning" n={5}>
            {t.awesome}
          </SectionHeading>
